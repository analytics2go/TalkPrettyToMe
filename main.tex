...
At present, there is not an easy way to view insights from data and processes within the system which could be used to make the reservation system more economically manageable and provide increased user satisfaction and usability.  The approach that will be used to fulfill this goal, is to create a distributed application implemented in MySQL, Python and Django, using Google Cloud Computing. 
